...
public class MainApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Files Fetched");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("FILE BACKUP");
        ...
        jLabel1.setText("ODS - BACKUP MANAGEMENT TOOLKIT");
        ...
        jLabel7.setText("DB BACKUP");

        jButton3.setText("Start Backup");
...
// TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        jLabel8.setText("1 Exporting Remote DB");
        dw = new SQLDumpWorker();
            dw.addPropertyChangeListener(new PropertyChangeListener() {
                ...
                public void propertyChange(PropertyChangeEvent evt) {
                    if ("progress".equals(evt.getPropertyName())) {
                        ...
                        System.out.println("propertyChange called with: " + value);
                        switch(value){
                            case 1 : jLabel9.setText("2 Copying to Local Storage");break;
                            case 2 : jLabel10.setText("3 Importing to local DB");break;
